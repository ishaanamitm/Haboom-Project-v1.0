...
WebUI.setEncryptedText(findTestObject('Login Page 2/Login Page 2 Password'), 'Ae2KZyjYBr0MQlyqU7ThAA==')

WebUI.click(findTestObject('Login Page 2/Login page 2 Login button'))

WebUI.verifyElementText(findTestObject('Login/Account Text'), 'My Account')
